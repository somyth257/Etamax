 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="javascript:void(0);" class="icon" onclick="myFunction()">
    <i class="fa fa-bars"></i>
     ...
     <form action="Events_login.php" method="post">
<center>
...
<div class="row">
   <div class="column" >
    ...
    <p>Participation Fee: 400(2)</p>
    <p>Venue: FOYER & CR101</p></div></div>
    </div>
  ...
  <div class="column">
   <div class="container">
    ...
    <p>Participation Fee: 100</p>
    <p>Venue: WIRELESS LAB</p></div></div>
      </div>
