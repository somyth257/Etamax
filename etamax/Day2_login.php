...
if(isset($_POST['event4'])){
    $query="UPDATE signup SET event4='Y' WHERE s_roll={$_SESSION['roll']} ";
...
if(isset($_POST['event5'])){
    $query="UPDATE signup SET event5='Y' WHERE s_roll={$_SESSION['roll']} ";
    $result=mysqli_query($connection,$query);
    if(!$result){
        die("UPDATE FAILED".mysqli_error);
    }
...
if(isset($_POST['event6'])){
    $query="UPDATE signup SET event6='Y' WHERE s_roll={$_SESSION['roll']} ";
    $result=mysqli_query($connection,$query);
    if(!$result){
        die("UPDATE FAILED".mysqli_error);
    }
...
<a href="Home_login.php"><img src="images/logo1.png" id="logo"></a> 
 <div class="topnav" id="myTopnav">
  ...
  <a href="javascript:void(0);" class="icon" onclick="myFunction()">
    ...
    <form action="Day2_login.php" method="post">
<center>
<div style="height:auto;margin-top:100px;margin-bottom: 50px">
      ...
      <ul id="menu">
          ...
          <li><a style="color:rgb(34,19,51);" href="Day2_login.php"><b>DAY 2</b></a></li>
